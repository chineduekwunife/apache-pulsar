...
public class PulsarReceiver extends Receiver<byte[]> {

    private static final Logger LOG = LoggerFactory.getLogger(PulsarReceiver.class);
    ...
    public PulsarReceiver(StorageLevel storageLevel,
                          String serviceUrl,
